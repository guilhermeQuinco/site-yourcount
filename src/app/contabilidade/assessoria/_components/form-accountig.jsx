...
const FormAccounting = () => {
  return (
    <section className="w-full bg-[#1b2f53] -z-10" id="form">
      <div className="max-container padding-container flex flex-col items-center lg:gap-56 gap-28  py-10  lg:py-20 lg:flex-row">
